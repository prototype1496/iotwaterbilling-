                                ...
                                <div class="widget">
                                    <div class="widget-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="state">
                                                <h6>Total Yearly Revenue Income</h6>
                                                <h2><?php echo $get_dashboared_stm['YearlyRevenue'];?></h2>
                                            </div>
                                            <div class="icon">
                                                <i class="ik ik-credit-card"></i>
                                            </div>
                                        </div>
                                        <small class="text-small mt-10 d-block"><?php echo $get_dashboared_stm['RiseInRrevenue'];?> % higher than last year</small>
                                    </div>
                                    ...
                                    <div class="widget-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="state">
                                                ...
                                                <h2><?php echo $get_dashboared_stm['MonthlyRevenue'];?></h2>
                                            </div>
                                            <div class="icon">
                                                <i class="ik ik-credit-card"></i>
                                            </div>
                                        </div>
                                        <small class="text-small mt-10 d-block"><?php echo $get_dashboared_stm['MonthInRrevenue'];?>% higher than last month</small>
                                    </div>
                                    <div class="progress progress-sm">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="widget">
                                    <div class="widget-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="state">
                                                <h6>Customer Owed Revenue</h6>
                                                <h2>K <?php echo $get_dashboared_stm['Owed'];?></h2>
                                            </div>
                                            <div class="icon">
                                                <i class="ik ik-credit-card"></i>
                                            </div>
                                        </div>
                                        <small class="text-small mt-10 d-block">Total Cutomers: <?php echo $totle =  $get_dashboared_stm['TotalCustomers'];?></small>
                                    </div>
                                    <div class="progress progress-sm">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="widget">
                                    <div class="widget-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="state">
                                                <h6>Disconected Customers</h6>
                                                <h2><?php echo $get_dashboared_stm['DisconnectedMembers'];?></h2>
                                            </div>
                                            <div class="icon">
                                                <i class="ik ik-credit-card"></i>
                                            </div>
                                        </div>
                                        <small class="text-small mt-10 d-block">Total Cutomers: <?php echo $totle;?></small>
                                    </div>
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-info" role="progressbar" aria-valuenow="1" aria-valuemin="0" aria-valuemax="100" style="width: 1%;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
